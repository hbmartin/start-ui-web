...
export const PageLayoutTopBar = (props: {
  ...
  return (
    <div
      className={cn(
        'z-10 flex min-w-0 flex-col items-center justify-end overflow-hidden border-b border-b-shell-border bg-shell pt-safe-top md:-mt-px md:[--page-layout-topbar-height:48px]',
        props.className
      )}
      style={{
